             ...
             <div class="col-xl-3 col-lg-3 col-md-6 pb-30 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".3s">
                <div class="tp-footer__widget footer-widget-2 footer-col-2-1">
                   <div class="tp-footer__logo mb-25">
                      <a href="index.html">
                         <img src="assets/logo_with_full_name.svg" alt="">
                      </a>
                   </div>
                   <div class="tp-footer__contact-info">
                      ...
                      <ul>
                         <li>
                            ...
                            <a class="first-child" href="tel:+1 (985) 261-4596">+1 (985) 261-4596</a>
                         </li>
                         <li>
                            <span>
          ...
          <div class="row align-items-center">
             ...
             <div class="col-xl-6 col-lg-6 col-md-6  d-none d-md-block">
                <div class="tp-copyright__text tp-copyright__text-2 text-center">
                   <span>Full Copyright & Design By <a href="#">EdvertX</a> – 2024</span>
                </div>
             </div>-->
             <!-- <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6">
                <div
             ...
             <div style="height: 30px; background-color: #FFCE57;">
               <p class="text-center" style="color: black;">Nurtured with Love in <img height="25px" width="30px" src="assets/indian-flag.png" /></p>
             </div>
 `)
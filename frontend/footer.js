document.write(`
<footer>
<div class="tp-footer__pl-pr text-blue-bg tp-footer-style-2">
       ...
       <div class="container">
          <div class="row">
             ...
             <div style="height: 30px; background-color: #FFCE57;">
               <p class="text-center" style="color: black;">Proudly securing from <img height="25px" width="30px" src="assets/indian-flag.png" /></p>
             </div>
 `)